...
วิธีใช้:
  ...
  2. ติดตั้ง Python 3.10+ ถ้ายังไม่มี (https://www.python.org/downloads/)
  3. เปิด PowerShell ในโฟลเดอร์นี้แล้วรัน:
         pip install rapidocr-onnxruntime onnxruntime
     ครั้งแรกอาจใช้เวลา ~2-3 นาที (ดาวน์โหลดโมเดล)
  4. ดับเบิ้ลคลิก AutoPilot.exe
